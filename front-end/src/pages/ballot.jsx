...
//     const [candidates, setCandidates] = useState({}); // Store candidates by ballot_id
...
//     const handleCandidateDropdown = (index) => {
//         // setCandidateDropdown((prev) => (prev === index ? null : index));
...
//             // if (candidateDropdown != null) {
//             //     const candidateDropdownEl = candidateDropdownRef.current[candidateDropdown];
//             //     const candidateButtonEl = candidateButtonRef.current[candidateDropdown]
//             //     if (candidateDropdownEl && 
//             //         !candidateDropdownEl.contains(e.target) &&
//             //         candidateButtonEl &&
//             //        !candidateButtonEl.contains(e.target)
//             //     ) {
//             //         setCandidateDropdown(null);
//             //     }
//             // }
...
//                 if (candidateDropdownEl && !candidateDropdownEl.contains(e.target) && candidateButtonEl && !candidateButtonEl.contains(e.target)) {
//                     setCandidateDropdown((prev) => ({
//                         ...prev,
//                         [key]: false
//                     }));
...
//                                                 {candidate.title} {/* Replace with candidate property */}
//                                             </div>
//                                             <button
//                                                 ref={(el) => (candidateButtonRef.current[idx] = el)} 
//                                                 className="bg-[#e3e7ea] px-[.5rem] py-[.7rem] rounded" 
//                                                 onClick={() => handleCandidateDropdown(idx)}
//                                             >
//                                                 <FaEllipsisH />
//                                             </button>
//                                             <div
//                                                 ref={(el) => (candidateDropdownRef.current[idx] = el)} 
//                                                 className={`border flex flex-col gap-3 px-[1rem] py-[.5rem] shadow absolute  bg-white ${candidateDropdown === idx ? 'block mt-[7.5rem] right-[3.5rem] lg:right-[15rem]' : 'hidden'}`} 
//                                             >
//                                                 <div 
//                                                     className="flex items-center gap-3 cursor-pointer"
...
//     // election_id: PropTypes.number.isRequired,
// }
